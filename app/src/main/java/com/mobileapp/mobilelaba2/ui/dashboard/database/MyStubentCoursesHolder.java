...
public class MyStubentCoursesHolder extends RecyclerView.ViewHolder {
    TextView pibView, gradesView, addressView, idView, nameView;
    public MyStubentCoursesHolder(@NonNull View itemView) {
        super(itemView);
